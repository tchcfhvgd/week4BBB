...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Friday Night Funkin Baby Blue Brother", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Friday Night Funkin Baby Blue Brother", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "72";
		app.meta["company"] = "HITLER";
		app.meta["file"] = "Friday Night Funkin Baby Blue Brother";
		app.meta["name"] = "Friday Night Funkin' Baby Blue Brother";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin' Baby Blue Brother",
			width: 1280,
			x: null,
			y: null,
		};
