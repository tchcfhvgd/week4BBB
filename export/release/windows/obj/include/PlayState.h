...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		static  ::Character dadAgain;
		static  ::Character gf;
		static  ::Boyfriend boyfriend;
		static  ::Boyfriend boyfriendAgain;
		static  ::Boyfriend runningGoblin;
		...
		bool isHalloween;
		 ...
		 ::flixel::FlxSprite goblinDeath;
		 ::flixel::FlxSprite babaPopup;
		 ::flixel::group::FlxTypedGroup grpLimoDancers;
		 ::flixel::FlxSprite bobmadshake;
		 ::flixel::_hx_system::FlxSound bobsound;
		...
		bool dadAgainSinging;
		bool dadAgainExist;
		bool dadSinging;
		bool boyfriendAgainSinging;
		bool boyfriendAgainExist;
		bool runningGoblinSinging;
		bool runningGoblinExist;
		bool boyfriendSigning;
		void create();

		void schoolIntro( ::DialogueBox dialogueBox);
		::Dynamic schoolIntro_dyn();

		void funnyIntro( ::DialogueBox dialogueBox);
		::Dynamic funnyIntro_dyn();
		...
		void resetBobismad();
		::Dynamic resetBobismad_dyn();

		void Bobismad();
		::Dynamic Bobismad_dyn();
		...
		void changeDaddy(::String id);
		::Dynamic changeDaddy_dyn();

		void changeBf(::String id);
		::Dynamic changeBf_dyn();

		void babaFrontPopup();
		::Dynamic babaFrontPopup_dyn();
