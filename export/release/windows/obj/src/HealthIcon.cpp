...
static const int _hx_array_data_f8f9be55_35[] = {
	(int)16,
};
static const int _hx_array_data_f8f9be55_36[] = {
	(int)44,(int)45,
};
static const int _hx_array_data_f8f9be55_37[] = {
	(int)39,(int)25,
};
static const int _hx_array_data_f8f9be55_38[] = {
	(int)46,(int)47,
};
static const int _hx_array_data_f8f9be55_39[] = {
	(int)46,(int)47,
};
static const int _hx_array_data_f8f9be55_40[] = {
	(int)48,(int)49,(int)50,(int)49,
};
static const int _hx_array_data_f8f9be55_41[] = {
	(int)51,
};
static const int _hx_array_data_f8f9be55_42[] = {
	(int)52,(int)53,
};
static const int _hx_array_data_f8f9be55_43[] = {
	(int)54,(int)55,
};
...
HXLINE(  40)		this->animation->add(HX_("baby",56,d9,10,41),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_23,2),0,false,isPlayer,null());
HXLINE(  41)		this->animation->add(HX_("homer",73,11,5e,2b),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_24,2),0,false,isPlayer,null());
HXLINE(  42)		this->animation->add(HX_("freddy",00,b5,23,af),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_25,2),0,false,isPlayer,null());
HXLINE(  43)		this->animation->add(HX_("scout",fe,75,d9,78),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_26,2),0,false,isPlayer,null());
HXLINE(  44)		this->animation->add(HX_("miku",06,4c,5c,48),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_27,2),0,false,isPlayer,null());
HXLINE(  45)		this->animation->add(HX_("pewdiepie",6e,0d,da,e2),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_28,2),0,false,isPlayer,null());
HXLINE(  46)		this->animation->add(HX_("tinky",47,87,36,10),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_29,2),0,false,isPlayer,null());
HXLINE(  47)		this->animation->add(HX_("monstershit",da,38,28,be),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_30,2),0,false,isPlayer,null());
HXLINE(  48)		this->animation->add(HX_("running-goblin",25,86,29,60),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_31,2),0,false,isPlayer,null());
HXLINE(  49)		this->animation->add(HX_("evil-baby",ef,a8,70,fd),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_32,2),0,false,isPlayer,null());
HXLINE(  50)		this->animation->add(HX_("gametoons",a7,12,1c,b6),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_33,2),0,false,isPlayer,null());
HXLINE(  51)		this->animation->add(HX_("screamer",1c,aa,0e,c3),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_34,2),0,false,isPlayer,null());
HXLINE(  52)		this->animation->add(HX_("alien",07,55,91,21),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_35,1),0,false,isPlayer,null());
HXLINE(  53)		this->animation->add(HX_("bob",f5,bd,4a,00),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_36,2),0,false,isPlayer,null());
HXLINE(  54)		this->animation->add(HX_("player-baby",02,29,ca,9d),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_37,2),0,false,isPlayer,null());
HXLINE(  55)		this->animation->add(HX_("bob-ron",79,d8,2e,d8),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_38,2),0,false,isPlayer,null());
HXLINE(  56)		this->animation->add(HX_("ron",11,e2,56,00),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_39,2),0,false,isPlayer,null());
HXLINE(  57)		this->animation->add(HX_("bobcreature",b4,e0,d9,a1),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_40,4),4,true,isPlayer,null());
HXLINE(  58)		this->animation->add(HX_("bobdead",19,ab,7f,fc),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_41,1),0,false,isPlayer,null());
HXLINE(  59)		this->animation->add(HX_("bf-baby",bf,37,b7,dd),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_42,2),0,false,isPlayer,null());
HXLINE(  60)		this->animation->add(HX_("bf-baby-goblin",65,74,ec,82),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_43,2),0,false,isPlayer,null());
HXLINE(  61)		this->animation->play(_hx_char,null(),null(),null());
HXLINE(  63)		::String _hx_switch_0 = _hx_char;
...
HXDLIN(  66)			goto _hx_goto_0;
            		...
            		_hx_goto_0:;
HXLINE(  69)		this->scrollFactor->set(null(),null());
            	}
