...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_238_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",238,0x0e5db805)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_202_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",202,0x0e5db805)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_218_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",218,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_225_update,"MainMenuState","update",0x766d017e,"MainMenuState.update","MainMenuState.hx",225,0x0e5db805)
HX_LOCAL_STACK_FRAME(_hx_pos_b0351dbbcbe2d566_243_goToState,"MainMenuState","goToState",0xcf6f00f9,"MainMenuState.goToState","MainMenuState.hx",243,0x0e5db805)
...
HXLINE(  54)		::DiscordClient_obj::changePresence(HX_("In the Menus",0a,c1,ad,c6),null(),null(),null(),null());
...
HXDLIN(  59)			_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("menu_music_1",f7,2c,7b,11)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
            		}
...
void MainMenuState_obj::update(Float elapsed){
            		...
            		void _hx_run( ::flixel::FlxSprite spr){
            			HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_238_update)
HXLINE( 238)			spr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_140_update)
HXLINE( 139)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 141)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 143)			 ::flixel::_hx_system::FlxSound _g = ::flixel::FlxG_obj::sound->music;
HXDLIN( 143)			_g->set_volume((_g->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 146)		 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 146)		if (_this->keyManager->checkStatus(80,_this->status)) {
HXLINE( 147)			if ((this->poop == 0)) {
HXLINE( 147)				this->poop = 1;
            			}
            		}
HXLINE( 150)		 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 150)		if (_this1->keyManager->checkStatus(79,_this1->status)) {
HXLINE( 151)			if ((this->poop == 1)) {
HXLINE( 151)				this->poop = 2;
            			}
            		}
HXLINE( 154)		 ::flixel::input::keyboard::FlxKeyList _this2 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 154)		if (_this2->keyManager->checkStatus(79,_this2->status)) {
HXLINE( 155)			if ((this->poop == 2)) {
HXLINE( 155)				this->poop = 3;
            			}
            		}
HXLINE( 158)		 ::flixel::input::keyboard::FlxKeyList _this3 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 158)		if (_this3->keyManager->checkStatus(80,_this3->status)) {
HXLINE( 159)			if ((this->poop == 3)) {
HXLINE( 159)				this->poop = 4;
            			}
            		}
HXLINE( 162)		if ((this->poop == 4)) {
HXLINE( 164)			 ::flixel::FlxState nextState =  ::EndState_obj::__alloc( HX_CTX );
HXDLIN( 164)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 164)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
HXLINE( 167)		if (!(this->selectedSomethin)) {
HXLINE( 169)			if (::PlayerSettings_obj::player1->controls->_upP->check()) {
...
HXLINE( 175)			if (::PlayerSettings_obj::player1->controls->_downP->check()) {
...
HXLINE( 188)				if ((this->optionShit->__get(this->curSelected) == HX_("donate",6f,f1,29,2e))) {
HXLINE( 190)					this->fancyOpenURL(HX_("https://www.kickstarter.com/projects/funkin/friday-night-funkin-the-full-ass-game",a5,2d,fa,b7));
            				}
            				else {
            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_3, ::MainMenuState,_gthis) HXARGC(1)
            					void _hx_run( ::flixel::FlxSprite spr){
            						HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_202_update)
HXLINE( 202)						if ((_gthis->curSelected != spr->ID)) {
...
HXLINE( 204)							::flixel::tweens::FlxTween_obj::tween(spr, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 214)							if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )) {
            								...
            								void _hx_run( ::flixel::effects::FlxFlicker flick){
            									HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_218_update)
HXLINE( 218)									_gthis->goToState();
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 216)								::flixel::effects::FlxFlicker_obj::flicker(spr,1,((Float)0.06),false,false, ::Dynamic(new _hx_Closure_1(_gthis)),null());
            							}
            							else {
            								HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_2, ::MainMenuState,_gthis) HXARGC(1)
            								void _hx_run( ::flixel::util::FlxTimer tmr){
            									HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_225_update)
HXLINE( 225)									_gthis->goToState();
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 223)								 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(1, ::Dynamic(new _hx_Closure_2(_gthis)),null());
            							}
            						}
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 194)					this->selectedSomethin = true;
...
HXLINE( 198)						::flixel::effects::FlxFlicker_obj::flicker(this->magenta,((Float)1.1),((Float)0.15),false,null(),null(),null());
            					}
...
HXLINE( 236)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_4()),null());
            	}


void MainMenuState_obj::goToState(){
            	HX_GC_STACKFRAME(&_hx_pos_b0351dbbcbe2d566_243_goToState)
HXLINE( 244)		::String daChoice = this->optionShit->__get(this->curSelected);
HXLINE( 246)		::String _hx_switch_0 = daChoice;
            		if (  (_hx_switch_0==HX_("freeplay",a0,90,86,22)) ){
HXLINE( 252)			this->super::openSubState( ::ChooseSubState_obj::__alloc( HX_CTX ));
HXLINE( 254)			::haxe::Log_obj::trace(HX_("Freeplay Menu Selected",9c,6d,5a,ca),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),254,HX_("MainMenuState",59,88,5e,20),HX_("goToState",4e,a5,e1,c9)));
HXLINE( 251)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_0==HX_("options",5e,33,fe,df)) ){
HXLINE( 257)			 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 257)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 257)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
HXDLIN( 257)			goto _hx_goto_11;
            		}
...
HXLINE( 250)			::haxe::Log_obj::trace(HX_("Story Menu Selected",71,ff,9b,4a),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),250,HX_("MainMenuState",59,88,5e,20),HX_("goToState",4e,a5,e1,c9)));
HXLINE( 248)			goto _hx_goto_11;
            		}
            		_hx_goto_11:;
            	}
...
HXLINE( 274)			spr->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 276)			bool _hx_tmp;
HXDLIN( 276)			if ((spr->ID == _gthis->curSelected)) {
HXLINE( 276)				_hx_tmp = ::MainMenuState_obj::finishedFunnyMove;
            			}
            			else {
...
HXLINE( 263)		if (::MainMenuState_obj::finishedFunnyMove) {
HXLINE( 265)			 ::MainMenuState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 265)			_hx_tmp->curSelected = (_hx_tmp->curSelected + huh);
HXLINE( 267)			if ((this->curSelected >= this->menuItems->length)) {
HXLINE( 268)				this->curSelected = 0;
            			}
HXLINE( 269)			if ((this->curSelected < 0)) {
HXLINE( 270)				this->curSelected = (this->menuItems->length - 1);
            			}
            		}
HXLINE( 272)		this->menuItems->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
...
void MainMenuState_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(poop,"poop");
...
::hx::Val MainMenuState_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		if (HX_FIELD_EQ(inName,"poop") ) { return ::hx::Val( poop ); }
		break;
	case 6:
...
::hx::Val MainMenuState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"poop") ) { poop=inValue.Cast< int >(); return inValue; }
		break;
	case 7:
...
void MainMenuState_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("poop",e0,80,5c,4a));
...
static ::hx::StorageInfo MainMenuState_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(MainMenuState_obj,poop),HX_("poop",e0,80,5c,4a)},
...
HXDLIN(  43)		kadeEngineVer = (HX_("1.5.1",fb,9c,32,55) + ::MainMenuState_obj::nightly);
            	}
{
