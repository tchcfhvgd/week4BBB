...
HXLINE(  31)			_hx_tmp1 = (Text.length <= 0);
            		}
            		else {
...
HXLINE(  31)			_hx_tmp = (this->textField->get_textHeight() + 4);
            		}
...
HXLINE( 122)		this->textField->set_x((this->x - this->offset->x));
HXLINE( 123)		this->textField->set_y((this->y - this->offset->y));
