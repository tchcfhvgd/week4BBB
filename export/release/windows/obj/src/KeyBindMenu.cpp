...
HXLINE( 176)				{
HXLINE( 176)					 ::flixel::text::FlxText _g = this->keyTextDisplay;
...
HXDLIN( 176)					_g->set_text((_g->text + (((((textStart + this->keyText->__get(0)) + HX_(": ",a6,32,00,00)) + _hx_tmp) + this->keyText->__get(0)) + HX_(" ARROW\n",61,9a,2c,9d))));
            				}
            			}
HXLINE( 173)			{
...
HXLINE( 176)				{
HXLINE( 176)					 ::flixel::text::FlxText _g1 = this->keyTextDisplay;
...
HXDLIN( 176)					_g1->set_text((_g1->text + (((((textStart1 + this->keyText->__get(1)) + HX_(": ",a6,32,00,00)) + _hx_tmp1) + this->keyText->__get(1)) + HX_(" ARROW\n",61,9a,2c,9d))));
            				}
            			}
HXLINE( 173)			{
...
HXLINE( 176)				{
HXLINE( 176)					 ::flixel::text::FlxText _g2 = this->keyTextDisplay;
...
HXDLIN( 176)					_g2->set_text((_g2->text + (((((textStart2 + this->keyText->__get(2)) + HX_(": ",a6,32,00,00)) + _hx_tmp2) + this->keyText->__get(2)) + HX_(" ARROW\n",61,9a,2c,9d))));
            				}
            			}
HXLINE( 173)			{
...
HXLINE( 176)				{
HXLINE( 176)					 ::flixel::text::FlxText _g3 = this->keyTextDisplay;
...
HXDLIN( 176)					_g3->set_text((_g3->text + (((((textStart3 + this->keyText->__get(3)) + HX_(": ",a6,32,00,00)) + _hx_tmp3) + this->keyText->__get(3)) + HX_(" ARROW\n",61,9a,2c,9d))));
            				}
            			}
            		}
