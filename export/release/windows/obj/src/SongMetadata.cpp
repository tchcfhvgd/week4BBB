...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_300_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",300,0x0d86f62d)
...
HXLINE( 304)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 303)		this->week = 0;
HXLINE( 302)		this->songName = HX_("",00,00,00,00);
HXLINE( 308)		this->songName = song;
HXLINE( 309)		this->week = week;
HXLINE( 310)		this->songCharacter = songCharacter;
            	}
