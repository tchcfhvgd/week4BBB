...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_122_toggleFPS,"Main","toggleFPS",0x9eefd060,"Main.toggleFPS","Main.hx",122,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_127_changeFPSColor,"Main","changeFPSColor",0xbde8c2bf,"Main.changeFPSColor","Main.hx",127,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_132_setFPSCap,"Main","setFPSCap",0x4fb5c496,"Main.setFPSCap","Main.hx",132,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_137_getFPSCap,"Main","getFPSCap",0x6c64d88a,"Main.getFPSCap","Main.hx",137,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_142_getFPS,"Main","getFPS",0xd3c70468,"Main.getFPS","Main.hx",142,0x087e5c05)
...
HXLINE(  99)		::String str1 = HX_("WEBM SHIT",e7,ff,8c,40);
HXLINE( 100)		 ::WebmHandler webmHandle =  ::WebmHandler_obj::__alloc( HX_CTX );
HXLINE( 101)		webmHandle->source(ourSource);
HXLINE( 102)		webmHandle->makePlayer();
HXLINE( 103)		webmHandle->webm->set_name(str1);
HXLINE( 104)		this->addChild(webmHandle->webm);
HXLINE( 105)		::GlobalVideo_obj::setWebm(webmHandle);
HXLINE( 110)		this->fpsCounter =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE( 111)		this->addChild(this->fpsCounter);
HXLINE( 112)		this->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
            	}
...
void Main_obj::toggleFPS(bool fpsEnabled){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_122_toggleFPS)
HXDLIN( 122)		this->fpsCounter->set_visible(fpsEnabled);
            	}
...
void Main_obj::changeFPSColor(int color){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_127_changeFPSColor)
HXDLIN( 127)		this->fpsCounter->set_textColor(color);
            	}
...
void Main_obj::setFPSCap(Float cap){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_132_setFPSCap)
HXDLIN( 132)		::openfl::Lib_obj::get_current()->stage->set_frameRate(cap);
            	}
...
Float Main_obj::getFPSCap(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_137_getFPSCap)
HXDLIN( 137)		return ::openfl::Lib_obj::get_current()->stage->get_frameRate();
            	}
...
Float Main_obj::getFPS(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_142_getFPS)
HXDLIN( 142)		return ( (Float)(this->fpsCounter->currentFPS) );
            	}
