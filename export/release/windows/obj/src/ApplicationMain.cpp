...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Friday Night Funkin Baby Blue Brother",3e,16,8f,b3),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("72",1b,30,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("HITLER",66,27,b2,09));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Friday Night Funkin Baby Blue Brother",3e,16,8f,b3));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin' Baby Blue Brother",f1,2a,e1,04));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin' Baby Blue Brother",f1,2a,e1,04))
