...
HXLINE( 283)		{
HXLINE( 283)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 283)			_g->set_y((_g->y + (this->row * 60)));
            		}
            	}
...
HXLINE( 343)			{
HXLINE( 343)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 343)				_g->set_y(_g->y);
            			}
...
HXLINE( 305)			{
HXLINE( 305)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 305)				_g->set_y(_g->y);
            			}
...
HXLINE( 301)			{
HXLINE( 301)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 301)				_g->set_y((_g->y + 50));
            			}
...
HXLINE( 350)			{
HXLINE( 350)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 350)				_g->set_y(_g->y);
            			}
...
HXLINE( 315)			{
HXLINE( 315)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 315)				_g->set_y((_g->y + 50));
            			}
