...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_64_update,"GameOverSubstate","update",0x4cd2a460,"GameOverSubstate.update","GameOverSubstate.hx",64,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_106_beatHit,"GameOverSubstate","beatHit",0xc1b25846,"GameOverSubstate.beatHit","GameOverSubstate.hx",106,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_115_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",115,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_125_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",125,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_123_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",123,0x01fbc1e7)

void GameOverSubstate_obj::__construct(Float x,Float y){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_10_new)
HXLINE( 111)		this->isEnding = false;
HXLINE(  15)		this->stageSuffix = HX_("",00,00,00,00);
HXLINE(  14)		this->normalBF = true;
HXLINE(  19)		::String daStage = ::PlayState_obj::curStage;
HXLINE(  20)		::String daBf = HX_("",00,00,00,00);
HXLINE(  21)		::String _hx_switch_0 = ( (::String)(::PlayState_obj::SONG->__Field(HX_("player1",b0,09,15,8a),::hx::paccDynamic)) );
...
HXLINE(  27)			this->normalBF = false;
HXLINE(  28)			this->stageSuffix = HX_("-baby",03,f4,18,2a);
HXLINE(  29)			daBf = HX_("player-baby",02,29,ca,9d);
...
HXDLIN(  41)		this->camFollow =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,_hx_tmp,this->bf->getGraphicMidpoint(null())->y,1,1);
HXLINE(  42)		this->add(this->camFollow);
HXLINE(  44)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN(  44)		_hx_tmp1->play(::Paths_obj::sound((HX_("fnf_loss_sfx",6a,36,72,11) + this->stageSuffix),null()),null(),null(),null(),null(),null());
HXLINE(  45)		if ((daBf == HX_("player-baby",02,29,ca,9d))) {
HXLINE(  47)			::Conductor_obj::changeBPM(( (Float)(103) ));
            		}
            		else {
HXLINE(  51)			::Conductor_obj::changeBPM(( (Float)(100) ));
            		}
HXLINE(  57)		::flixel::FlxG_obj::camera->scroll->set(null(),null());
HXLINE(  58)		::flixel::FlxG_obj::camera->target = null();
HXLINE(  60)		this->bf->playAnim(HX_("firstDeath",e4,d8,fc,14),null(),null(),null());
            	}
...
void GameOverSubstate_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_64_update)
HXLINE(  65)		this->super::update(elapsed);
HXLINE(  67)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE(  69)			this->endBullshit();
            		}
HXLINE(  72)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE(  74)			{
HXLINE(  74)				 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN(  74)				_this->cleanup(_this->autoDestroy,true);
            			}
...
HXLINE(  80)			::PlayState_obj::loadRep = false;
            		}
HXLINE(  83)		bool _hx_tmp;
HXDLIN(  83)		bool _hx_tmp1;
HXDLIN(  83)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  83)			_hx_tmp1 = (this->bf->animation->_curAnim->curFrame == 12);
            		}
            		else {
HXLINE(  83)			_hx_tmp1 = false;
            		}
HXDLIN(  83)		if (_hx_tmp1) {
HXLINE(  83)			_hx_tmp = this->normalBF;
            		}
            		else {
HXLINE(  83)			_hx_tmp = false;
            		}
HXDLIN(  83)		if (_hx_tmp) {
HXLINE(  85)			::flixel::FlxG_obj::camera->follow(this->camFollow,::flixel::FlxCameraFollowStyle_obj::LOCKON_dyn(),((Float)0.01));
            		}
HXLINE(  87)		bool _hx_tmp2;
HXDLIN(  87)		bool _hx_tmp3;
HXDLIN(  87)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  87)			_hx_tmp3 = (this->bf->animation->_curAnim->curFrame == 16);
            		}
            		else {
HXLINE(  87)			_hx_tmp3 = false;
            		}
HXDLIN(  87)		if (_hx_tmp3) {
HXLINE(  87)			_hx_tmp2 = !(this->normalBF);
            		}
            		else {
...
HXLINE(  93)		bool _hx_tmp4;
HXDLIN(  93)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  93)			_hx_tmp4 = this->bf->animation->_curAnim->finished;
            		}
            		else {
...
HXDLIN(  95)			_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOver",66,92,de,b5) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
            		}
HXLINE(  98)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
HXLINE( 100)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
            	}


void GameOverSubstate_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_b2ae8d30512793fc_106_beatHit)
HXDLIN( 106)		this->super::beatHit();
            	}


void GameOverSubstate_obj::endBullshit(){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_115_endBullshit)
HXDLIN( 115)		if (!(this->isEnding)) {
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_125_endBullshit)
HXLINE( 125)					 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
HXLINE( 125)						::flixel::FlxG_obj::game->_requestedState = nextState;
            				...
            				HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_123_endBullshit)
HXLINE( 123)				::flixel::FlxG_obj::camera->fade(-16777216,2,false, ::Dynamic(new _hx_Closure_0()),null());
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 117)			this->isEnding = true;
HXLINE( 118)			this->bf->playAnim(HX_("deathConfirm",2c,44,2b,12),true,null(),null());
HXLINE( 119)			{
HXLINE( 119)				 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 119)				_this->cleanup(_this->autoDestroy,true);
            			}
HXLINE( 120)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 120)			::String library = null();
HXDLIN( 120)			_hx_tmp->play(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOverEnd",15,2d,a9,8d) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null(),null(),null());
HXLINE( 121)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.7), ::Dynamic(new _hx_Closure_1()),null());
            		}
            	}
...
void GameOverSubstate_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(normalBF,"normalBF");
...
void GameOverSubstate_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(normalBF,"normalBF");
...
::hx::Val GameOverSubstate_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"normalBF") ) { return ::hx::Val( normalBF ); }
...
::hx::Val GameOverSubstate_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"normalBF") ) { normalBF=inValue.Cast< bool >(); return inValue; }
...
void GameOverSubstate_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("normalBF",ab,c3,47,33));
...
static ::hx::StorageInfo GameOverSubstate_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsBool,(int)offsetof(GameOverSubstate_obj,normalBF),HX_("normalBF",ab,c3,47,33)},
