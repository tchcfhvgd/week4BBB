...
HXLINE( 414)		 ::Dynamic _hx_tmp = ::flixel::FlxG_obj::save->data;
HXDLIN( 414)		_hx_tmp->__SetField(HX_("scrollSpeed",3a,e0,46,cb),(_hx_tmp->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic) + ((Float)0.1)),::hx::paccDynamic);
...
HXLINE( 429)		 ::Dynamic _hx_tmp = ::flixel::FlxG_obj::save->data;
HXDLIN( 429)		_hx_tmp->__SetField(HX_("scrollSpeed",3a,e0,46,cb),( ::Dynamic(_hx_tmp->__Field(HX_("scrollSpeed",3a,e0,46,cb),::hx::paccDynamic)) - ((Float)0.1)),::hx::paccDynamic);
