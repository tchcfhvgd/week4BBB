...
HX_LOCAL_STACK_FRAME(_hx_pos_5489bc77b33b3e4d_86_loadJson,"AnimationDebug","loadJson",0x7e3866ed,"AnimationDebug.loadJson","AnimationDebug.hx",86,0x57f8f54f)
HX_LOCAL_STACK_FRAME(_hx_pos_5489bc77b33b3e4d_92_genBoyOffsets,"AnimationDebug","genBoyOffsets",0xa90e05a5,"AnimationDebug.genBoyOffsets","AnimationDebug.hx",92,0x57f8f54f)
HX_LOCAL_STACK_FRAME(_hx_pos_5489bc77b33b3e4d_112_updateTexts,"AnimationDebug","updateTexts",0xfaa95a3e,"AnimationDebug.updateTexts","AnimationDebug.hx",112,0x57f8f54f)
HX_LOCAL_STACK_FRAME(_hx_pos_5489bc77b33b3e4d_110_updateTexts,"AnimationDebug","updateTexts",0xfaa95a3e,"AnimationDebug.updateTexts","AnimationDebug.hx",110,0x57f8f54f)
HX_LOCAL_STACK_FRAME(_hx_pos_5489bc77b33b3e4d_119_update,"AnimationDebug","update",0x3691abc8,"AnimationDebug.update","AnimationDebug.hx",119,0x57f8f54f)
...
void AnimationDebug_obj::loadJson(::String song){
            	HX_GC_STACKFRAME(&_hx_pos_5489bc77b33b3e4d_86_loadJson)
HXLINE(  87)		::String _hx_tmp = song.toLowerCase();
HXDLIN(  87)		::PlayState_obj::SONG = ::Song_obj::loadFromJson(_hx_tmp,song.toLowerCase());
HXLINE(  88)		{
HXLINE(  88)			 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::ChartingState_obj::__alloc( HX_CTX ,null(),null())) ),false);
...
HX_DEFINE_DYNAMIC_FUNC1(AnimationDebug_obj,loadJson,(void))

void AnimationDebug_obj::genBoyOffsets(::hx::Null< bool >  __o_pushList){
            		bool pushList = __o_pushList.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_5489bc77b33b3e4d_92_genBoyOffsets)
HXLINE(  93)		int daLoop = 0;
HXLINE(  95)		{
HXLINE(  95)			 ::Dynamic _g =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,this->_hx_char->animOffsets);
HXDLIN(  95)			while(( (bool)(_g->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  95)				 ::Dynamic _g1 = _g->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN(  95)				::String anim = ( (::String)(_g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic)) );
HXDLIN(  95)				::cpp::VirtualArray offsets = ( (::cpp::VirtualArray)(_g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXLINE(  96)				{
HXLINE(  97)					 ::flixel::text::FlxText text =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,10,(20 + (18 * daLoop)),0,((anim + HX_(": ",a6,32,00,00)) + ::Std_obj::string(offsets)),15,null());
HXLINE(  98)					text->scrollFactor->set(null(),null());
HXLINE(  99)					text->set_color(-16776961);
HXLINE( 100)					this->dumbTexts->add(text).StaticCast<  ::flixel::text::FlxText >();
HXLINE( 102)					if (pushList) {
HXLINE( 103)						this->animList->push(anim);
            					}
HXLINE( 105)					daLoop = (daLoop + 1);
            				}
            			}
            		}
            	}
...
void AnimationDebug_obj::updateTexts(){
            		...
            		void _hx_run( ::flixel::text::FlxText text){
            			HX_STACKFRAME(&_hx_pos_5489bc77b33b3e4d_112_updateTexts)
HXLINE( 113)			text->kill();
HXLINE( 114)			_gthis->dumbTexts->remove(text,true).StaticCast<  ::flixel::text::FlxText >();
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACKFRAME(&_hx_pos_5489bc77b33b3e4d_110_updateTexts)
HXLINE( 109)		 ::AnimationDebug _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 111)		this->dumbTexts->forEach( ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
...
void AnimationDebug_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_5489bc77b33b3e4d_119_update)
HXLINE( 120)		this->textAnim->set_text(this->_hx_char->animation->_curAnim->name);
HXLINE( 122)		 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 122)		if (_this->keyManager->checkStatus(69,_this->status)) {
HXLINE( 123)			 ::flixel::FlxCamera _g = ::flixel::FlxG_obj::camera;
HXDLIN( 123)			_g->set_zoom((_g->zoom + ((Float)0.25)));
            		}
HXLINE( 124)		 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 124)		if (_this1->keyManager->checkStatus(81,_this1->status)) {
HXLINE( 125)			 ::flixel::FlxCamera _g = ::flixel::FlxG_obj::camera;
HXDLIN( 125)			_g->set_zoom((_g->zoom - ((Float)0.25)));
            		}
HXLINE( 127)		bool _hx_tmp;
HXDLIN( 127)		bool _hx_tmp1;
HXDLIN( 127)		bool _hx_tmp2;
HXDLIN( 127)		 ::flixel::input::keyboard::FlxKeyList _this2 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 127)		if (!(_this2->keyManager->checkStatus(73,_this2->status))) {
HXLINE( 127)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 127)			_hx_tmp2 = _this->keyManager->checkStatus(74,_this->status);
            		}
            		else {
...
HXLINE( 127)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 127)			_hx_tmp1 = _this->keyManager->checkStatus(75,_this->status);
            		}
            		else {
...
HXLINE( 127)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 127)			_hx_tmp = _this->keyManager->checkStatus(76,_this->status);
            		}
            		else {
HXLINE( 127)			_hx_tmp = true;
            		}
HXDLIN( 127)		if (_hx_tmp) {
HXLINE( 129)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 129)			if (_this->keyManager->checkStatus(73,_this->status)) {
HXLINE( 130)				this->camFollow->velocity->set_y(( (Float)(-90) ));
            			}
            			else {
HXLINE( 131)				 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 131)				if (_this->keyManager->checkStatus(75,_this->status)) {
HXLINE( 132)					this->camFollow->velocity->set_y(( (Float)(90) ));
            				}
            				else {
HXLINE( 134)					this->camFollow->velocity->set_y(( (Float)(0) ));
            				}
            			}
HXLINE( 136)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 136)			if (_this1->keyManager->checkStatus(74,_this1->status)) {
HXLINE( 137)				this->camFollow->velocity->set_x(( (Float)(-90) ));
            			}
            			else {
HXLINE( 138)				 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 138)				if (_this->keyManager->checkStatus(76,_this->status)) {
HXLINE( 139)					this->camFollow->velocity->set_x(( (Float)(90) ));
            				}
            				else {
HXLINE( 141)					this->camFollow->velocity->set_x(( (Float)(0) ));
            				}
            			}
            		}
            		else {
HXLINE( 145)			this->camFollow->velocity->set(null(),null());
            		}
HXLINE( 148)		 ::flixel::input::keyboard::FlxKeyList _this3 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 148)		if (_this3->keyManager->checkStatus(87,_this3->status)) {
HXLINE( 150)			 ::AnimationDebug _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 150)			_hx_tmp->curAnim = (_hx_tmp->curAnim - 1);
            		}
HXLINE( 153)		 ::flixel::input::keyboard::FlxKeyList _this4 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 153)		if (_this4->keyManager->checkStatus(83,_this4->status)) {
HXLINE( 155)			 ::AnimationDebug _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 155)			_hx_tmp->curAnim = (_hx_tmp->curAnim + 1);
            		}
HXLINE( 158)		if ((this->curAnim < 0)) {
HXLINE( 159)			this->curAnim = (this->animList->length - 1);
            		}
HXLINE( 161)		if ((this->curAnim >= this->animList->length)) {
HXLINE( 162)			this->curAnim = 0;
            		}
HXLINE( 164)		bool _hx_tmp3;
HXDLIN( 164)		bool _hx_tmp4;
HXDLIN( 164)		 ::flixel::input::keyboard::FlxKeyList _this5 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 164)		if (!(_this5->keyManager->checkStatus(83,_this5->status))) {
HXLINE( 164)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 164)			_hx_tmp4 = _this->keyManager->checkStatus(87,_this->status);
            		}
            		else {
...
HXLINE( 164)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 164)			_hx_tmp3 = _this->keyManager->checkStatus(32,_this->status);
            		}
            		else {
HXLINE( 164)			_hx_tmp3 = true;
            		}
HXDLIN( 164)		if (_hx_tmp3) {
HXLINE( 166)			this->_hx_char->playAnim(this->animList->__get(this->curAnim),null(),null(),null());
HXLINE( 168)			this->updateTexts();
HXLINE( 169)			this->genBoyOffsets(false);
            		}
HXLINE( 172)		bool upP = ::flixel::FlxG_obj::keys->checkKeyArrayState(::Array_obj< int >::fromData( _hx_array_data_919878cf_8,1),2);
HXLINE( 173)		bool rightP = ::flixel::FlxG_obj::keys->checkKeyArrayState(::Array_obj< int >::fromData( _hx_array_data_919878cf_9,1),2);
HXLINE( 174)		bool downP = ::flixel::FlxG_obj::keys->checkKeyArrayState(::Array_obj< int >::fromData( _hx_array_data_919878cf_10,1),2);
HXLINE( 175)		bool leftP = ::flixel::FlxG_obj::keys->checkKeyArrayState(::Array_obj< int >::fromData( _hx_array_data_919878cf_11,1),2);
HXLINE( 177)		 ::flixel::input::keyboard::FlxKeyList _this6 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 177)		bool holdShift = _this6->keyManager->checkStatus(16,_this6->status);
HXLINE( 178)		int multiplier = 1;
HXLINE( 179)		if (holdShift) {
HXLINE( 180)			multiplier = 10;
            		}
HXLINE( 182)		bool _hx_tmp5;
HXDLIN( 182)		bool _hx_tmp6;
HXDLIN( 182)		bool _hx_tmp7;
HXDLIN( 182)		if (!(upP)) {
HXLINE( 182)			_hx_tmp7 = rightP;
            		}
            		else {
HXLINE( 182)			_hx_tmp7 = true;
            		}
HXDLIN( 182)		if (!(_hx_tmp7)) {
HXLINE( 182)			_hx_tmp6 = downP;
            		}
            		else {
HXLINE( 182)			_hx_tmp6 = true;
            		}
HXDLIN( 182)		if (!(_hx_tmp6)) {
HXLINE( 182)			_hx_tmp5 = leftP;
            		}
            		else {
HXLINE( 182)			_hx_tmp5 = true;
            		}
HXDLIN( 182)		if (_hx_tmp5) {
HXLINE( 184)			this->updateTexts();
HXLINE( 185)			if (upP) {
HXLINE( 186)				::cpp::VirtualArray _hx_tmp = ( (::cpp::VirtualArray)(this->_hx_char->animOffsets->get(this->animList->__get(this->curAnim))) );
HXDLIN( 186)				int _hx_tmp1 = 1;
HXDLIN( 186)				_hx_tmp->set(_hx_tmp1,(_hx_tmp->__get(_hx_tmp1) + multiplier));
            			}
HXLINE( 187)			if (downP) {
HXLINE( 188)				::cpp::VirtualArray _hx_tmp = ( (::cpp::VirtualArray)(this->_hx_char->animOffsets->get(this->animList->__get(this->curAnim))) );
HXDLIN( 188)				int _hx_tmp1 = 1;
HXDLIN( 188)				_hx_tmp->set(_hx_tmp1,(_hx_tmp->__get(_hx_tmp1) - multiplier));
            			}
HXLINE( 189)			if (leftP) {
HXLINE( 190)				::cpp::VirtualArray _hx_tmp = ( (::cpp::VirtualArray)(this->_hx_char->animOffsets->get(this->animList->__get(this->curAnim))) );
HXDLIN( 190)				int _hx_tmp1 = 0;
HXDLIN( 190)				_hx_tmp->set(_hx_tmp1,(_hx_tmp->__get(_hx_tmp1) + multiplier));
            			}
HXLINE( 191)			if (rightP) {
HXLINE( 192)				::cpp::VirtualArray _hx_tmp = ( (::cpp::VirtualArray)(this->_hx_char->animOffsets->get(this->animList->__get(this->curAnim))) );
HXDLIN( 192)				int _hx_tmp1 = 0;
HXDLIN( 192)				_hx_tmp->set(_hx_tmp1,(_hx_tmp->__get(_hx_tmp1) - multiplier));
            			}
HXLINE( 194)			this->updateTexts();
HXLINE( 195)			this->genBoyOffsets(false);
HXLINE( 196)			this->_hx_char->playAnim(this->animList->__get(this->curAnim),null(),null(),null());
            		}
HXLINE( 199)		this->super::update(elapsed);
HXLINE( 200)		 ::flixel::input::keyboard::FlxKeyList _this7 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 200)		if (_this7->keyManager->checkStatus(13,_this7->status)) {
HXLINE( 202)			 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::MainMenuState_obj::__alloc( HX_CTX ,null(),null())) ),false);
