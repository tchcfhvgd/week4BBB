...
HXLINE(  28)		 ::OutdatedSubState _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE(  32)		{
HXLINE(  32)			 ::flixel::math::FlxPoint _g = bg1->scale;
HXDLIN(  32)			_g->set_x((_g->x * ((Float)1.55)));
            		}
HXLINE(  33)		{
HXLINE(  33)			 ::flixel::math::FlxPoint _g1 = bg1->scale;
HXDLIN(  33)			_g1->set_y((_g1->y * ((Float)1.55)));
            		}
...
HXLINE(  40)		{
HXLINE(  40)			 ::flixel::FlxSprite _g2 = kadeLogo1;
HXDLIN(  40)			_g2->set_x((_g2->x - ( (Float)(kadeLogo1->frameHeight) )));
            		}
HXLINE(  41)		{
HXLINE(  41)			 ::flixel::FlxSprite _g3 = kadeLogo1;
HXDLIN(  41)			_g3->set_y((_g3->y - ( (Float)(180) )));
            		}
