...
HXDLIN( 103)				::String _hx_tmp1 = (HX_("return value not supported\n",48,41,fb,c8) + ::Std_obj::string(::Type_obj::_hx_typeof(v)));
HXDLIN( 103)				_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),103,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            			}
            		}
...
HXLINE( 186)									ret = ::llua::Convert_obj::toHaxeObj(l,-1);
            								...
            								default:{
HXLINE( 186)									ret = null();
HXDLIN( 186)									 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 186)									::String _hx_tmp1 = (HX_("return value not supported\n",48,41,fb,c8) + ::Std_obj::string(::Type_obj::_hx_typeof(-1)));
HXDLIN( 186)									_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),103,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            								}
            							}
...
HXLINE( 193)											ret = ::llua::Convert_obj::toHaxeObj(l,-1);
            										...
            										default:{
HXLINE( 193)											ret = null();
HXDLIN( 193)											 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 193)											::String _hx_tmp1 = (HX_("return value not supported\n",48,41,fb,c8) + ::Std_obj::string(::Type_obj::_hx_typeof(-1)));
HXDLIN( 193)											_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),103,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            										}
            									}
...
HXLINE( 194)												ret = ::llua::Convert_obj::toHaxeObj(l,-1);
            											...
            											default:{
HXLINE( 194)												ret = null();
HXDLIN( 194)												 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 194)												::String _hx_tmp1 = (HX_("return value not supported\n",48,41,fb,c8) + ::Std_obj::string(::Type_obj::_hx_typeof(-1)));
HXDLIN( 194)												_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),103,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            											}
            										}
