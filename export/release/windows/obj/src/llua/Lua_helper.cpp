...
HXLINE( 577)						ret = ::llua::Convert_obj::toHaxeObj(l,v);
            					...
            					default:{
HXLINE( 577)						ret = null();
HXDLIN( 577)						 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 577)						::String _hx_tmp1 = (HX_("return value not supported\n",48,41,fb,c8) + ::Std_obj::string(::Type_obj::_hx_typeof(v)));
HXDLIN( 577)						_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),103,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            					}
            				}
