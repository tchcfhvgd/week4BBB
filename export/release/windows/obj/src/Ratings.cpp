...
HXLINE(  48)					switch((int)(i)){
            						case (int)0: {
HXLINE(  51)							ranking = (ranking + HX_(" EPIC",25,3d,ab,9a));
            						}
            						break;
            						case (int)1: {
...
HXLINE(  75)							ranking = (ranking + HX_(" A",21,1c,00,00));
            						...
            						break;
            						case (int)13: {
HXLINE(  77)							ranking = (ranking + HX_(" SHIT",e0,27,e6,a3));
            						}
            						break;
            						case (int)14: {
HXLINE(  79)							ranking = (ranking + HX_(" SHIT",e0,27,e6,a3));
            						}
            						break;
            						case (int)15: {
HXLINE(  81)							ranking = (ranking + HX_(" SHIT",e0,27,e6,a3));
            						}
            						break;
            					}
