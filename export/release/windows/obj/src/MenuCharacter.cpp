...
HXLINE(  50)		this->animation->addByPrefix(HX_("spooky",eb,bd,9e,c1),HX_("Dad idle dance BLACK LINE",b5,ef,e0,8b),48,null(),null(),null());
HXLINE(  51)		this->animation->addByPrefix(HX_("pico",e5,e8,57,4a),HX_("Pico menu asset",ea,53,8c,9e),24,null(),null(),null());
...
HXDLIN(  24)			_g->set(HX_("dad",47,36,4c,00), ::CharacterSetting_obj::__alloc( HX_CTX ,50,100,2,null()));
HXDLIN(  24)			_g->set(HX_("spooky",eb,bd,9e,c1), ::CharacterSetting_obj::__alloc( HX_CTX ,50,100,2,null()));
HXDLIN(  24)			_g->set(HX_("pico",e5,e8,57,4a), ::CharacterSetting_obj::__alloc( HX_CTX ,-110,-60,((Float)1.5),null()));
