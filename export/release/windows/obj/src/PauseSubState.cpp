...
HXLINE(  48)		{
HXLINE(  48)			 ::flixel::text::FlxText _g = levelInfo;
HXDLIN(  48)			_g->set_text(( (::String)((_g->text + ::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic))) ));
            		}
...
HXLINE(  55)		{
HXLINE(  55)			 ::flixel::text::FlxText _g1 = levelDifficulty;
HXDLIN(  55)			::String _g2 = _g1->text;
HXDLIN(  55)			_g1->set_text((_g2 + ::CoolUtil_obj::difficultyString()));
            		}
...
HXLINE(  81)		{
HXLINE(  81)			int _g3 = 0;
HXDLIN(  81)			int _g4 = this->menuItems->length;
HXDLIN(  81)			while((_g3 < _g4)){
HXLINE(  81)				_g3 = (_g3 + 1);
HXDLIN(  81)				int i = (_g3 - 1);
HXLINE(  83)				 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false,null());
...
HXLINE(  97)			 ::flixel::_hx_system::FlxSound _g = this->pauseMusic;
HXDLIN(  97)			_g->set_volume((_g->_volume + (((Float)0.01) * elapsed)));
            		}
...
HXLINE( 135)								 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false,null());
...
HXLINE( 160)									 ::Alphabet songText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i) + 30)) ),this->menuItems->__get(i),true,false,null());
