...
HXLINE(  14)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("880937286122995722",30,a1,84,f7))
...
HXLINE(  59)		 ::Dynamic this1 =  ::__hxcpp_thread_create( ::Dynamic(new _hx_Closure_0()));
HXDLIN(  59)		 ::Dynamic DiscordDaemon = this1;
