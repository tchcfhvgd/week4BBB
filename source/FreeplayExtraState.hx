...
class FreeplayExtraState extends MusicBeatState
{
	...
	override function create()
	{
		...
		FlxG.sound.playMusic(Paths.music('moon'));
		...
		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('menuBGRed'));
		bg.y += -80;
		...
		scoreText.setFormat(Paths.font("funkin.otf"), 32, FlxColor.WHITE, RIGHT);
